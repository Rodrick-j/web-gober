    ...
    <section className={styles.sliderSection}>
      ...
      >
                ...
                <div className={styles.slideContentContainer}>
                  <div className={styles.glassCard}>
                    ...
                    <p className={styles.slideDesc}>
                      Impulsando el desarrollo integral del departamento con gestión eficiente, transparencia y obras de impacto.
                    </p>
                    
                    {banner.enlace_url && (
                      <div className={styles.actionWrapper}>
                        <Link href={banner.enlace_url} className={styles.primaryButton}>
                          <span>Saber más</span>
        ...
        <div className={styles.controlsContainer}>
          <button className={`${styles.navBtn} custom-nav-prev`} aria-label="Anterior">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M15 18l-6-6 6-6"/></svg>
          </button>
          <button className={`${styles.navBtn} custom-nav-next`} aria-label="Siguiente">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 18l6-6-6-6"/></svg>
          </button>
        </div>
      </Swiper>
      
      {/* Social Networks Floating Bar */}
      {redes && (
        <div className={styles.floatingSocials}>
          ...
          <a href="https://www.tiktok.com/@gobiernodeunidad" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className={`${styles.socialIcon} ${styles.tk}`}>
          ...
          <a href="https://www.youtube.com/@Gobernaci%C3%B3ndeOruro" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className={`${styles.socialIcon} ${styles.yt}`}>
