        ...
        <div className={styles.topBandInner}>
          ...
          <div className={styles.socialWrapper}>
            ...
            <div className={styles.socialLinks}>
              ...
              <a href="https://www.instagram.com/infounicom.gador/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={`${styles.socialLink} ${styles.ig}`}>
              ...
              <a href="https://www.tiktok.com/@gobiernodeunidad?_r=1&_t=ZS-97VsdEjk5VS" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className={`${styles.socialLink} ${styles.tk}`}>
              ...
              <a href="https://www.youtube.com/channel/UC5q5rDsXdlXm3fbYSk-AcuA" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className={`${styles.socialLink} ${styles.yt}`}>
